...
rainwiseView.makeTable = function (rw) {
  var table = '<tr><th>Item</th><th>Amount</th><th>Cost</th><th>Tax</th><th>Total</th></tr>';
  if (rw.gutterLength) {
